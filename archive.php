...
<div class="archive-box">
	<div class="ab-wrap">
		<?php
		if ( is_day() ) :
			echo _e( '<span>Daily Archives</span>', 'marigold' );
			printf( __( '<h1>%s</h1>', 'marigold' ), get_the_date() );

		elseif ( is_month() ) :
			echo _e( '<span>Monthly Archives</span>', 'marigold' );
			printf( __( '<h1>%s</h1>', 'marigold' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'marigold' ) ) );

		elseif ( is_year() ) :
			echo _e( '<span>Yearly Archives</span>', 'marigold' );
			printf( __( '<h1>%s</h1>', 'marigold' ), get_the_date( _x( 'Y', 'yearly archives date format', 'marigold' ) ) );

		else :
			_e( '<h1>Archives</h1>', 'marigold' );
